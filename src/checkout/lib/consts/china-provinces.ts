...
/** 直辖市、特别行政区：省级即市级，选择后「市」与省相同且不可编辑 */
export const CHINA_MUNICIPALITY_OR_SAR: ReadonlySet<string> = new Set([
	"北京市",
	"天津市",
	"上海市",
	"重庆市",
...
export const isChinaMunicipalityOrSAR = (countryArea: string): boolean =>
	CHINA_MUNICIPALITY_OR_SAR.has(countryArea);
